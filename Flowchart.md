...
graph TD
    ...
    %% INTERACTIVITY: Clickable Links (Update 'YourUsername' to your actual GitHub username)
    click B "[https://github.com/YourUsername/semicon_2k26/blob/main/evaluate.py](https://github.com/YourUsername/semicon_2k26/blob/main/evaluate.py)" "Click to view Data Loader code"
    click D "[https://github.com/YourUsername/semicon_2k26/blob/main/evaluate.py](https://github.com/YourUsername/semicon_2k26/blob/main/evaluate.py)" "Click to view NAFBlock architecture"
    click G "[https://github.com/YourUsername/semicon_2k26/blob/main/train.py](https://github.com/YourUsername/semicon_2k26/blob/main/train.py)" "Click to view Hybrid Loss function"
